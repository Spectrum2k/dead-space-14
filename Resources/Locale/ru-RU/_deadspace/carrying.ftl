carry-verb-pick-up = Поднять на руки

carry-popup-self = Вы не можете поднять себя на руки.
...
carry-popup-cannot-interact = Вы не можете дотянуться.
carry-popup-target-buckled = Существо пристегнуто.
carry-popup-no-free-hands = Для этого нужны обе свободные руки.
